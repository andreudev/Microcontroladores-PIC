...
void PWM1_Init(long freq){
    ...
    switch(6){
        case 0: valPre = 1; break;
        case 1: valPre = 2; break;
        case 2: valPre = 4; break;
        case 3: valPre = 8; break;
        case 4: valPre = 16; break;
        case 5: valPre = 32; break;
        case 6: valPre = 64; break;
        case 7: valPre = 128; break;
    }
    CCP1CONbits.FMT = 0;
    CCP1CONbits.EN = 1;
    ...
    T2TMR = 0;
    T2PR = (unsigned char)(64000000UL / (4.0*freq*valPre));
