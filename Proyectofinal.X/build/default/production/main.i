...
void __attribute__((picinterrupt(("irq(31)")))) timer(void){
    PIR3bits.TMR0IF = 0;
    TMR0L = 0x3C;
    cont++;
    if(flagriego==1){
...
void __attribute__((picinterrupt(("irq(8)")))) seguridad(void){
    PIR1bits.INT0IF = 0;
    if(seg==1){
        PORTCbits.RC1 = 1;
        flagalerta=1;
...
void __attribute__((picinterrupt(("irq(32)")))) RxFrames(void){
