...
# 3 "funtions_frame.c" 2

# 1 "./funtions_frame.h" 1
...
# 97 "./mcc_generated_files/uart1.h"
extern volatile uint8_t uart1TxBufferRemaining;
extern volatile uint8_t uart1RxCount;
extern char frame[16];
extern int index;
# 126 "./mcc_generated_files/uart1.h"
void UART1_Initialize(void);
# 174 "./mcc_generated_files/uart1.h"
_Bool UART1_is_rx_ready(void);
# 222 "./mcc_generated_files/uart1.h"
_Bool UART1_is_tx_ready(void);
# 269 "./mcc_generated_files/uart1.h"
_Bool UART1_is_tx_done(void);
# 317 "./mcc_generated_files/uart1.h"
uart1_status_t UART1_get_last_status(void);
# 366 "./mcc_generated_files/uart1.h"
uint8_t UART1_Read(void);
# 391 "./mcc_generated_files/uart1.h"
void UART1_Write(uint8_t txData);
# 412 "./mcc_generated_files/uart1.h"
void UART1_Transmit_ISR(void);
# 433 "./mcc_generated_files/uart1.h"
void UART1_Receive_ISR(void);
# 454 "./mcc_generated_files/uart1.h"
void UART1_RxDataHandler(void);
# 472 "./mcc_generated_files/uart1.h"
void UART1_SetFramingErrorHandler(void (* interruptHandler)(void));
# 490 "./mcc_generated_files/uart1.h"
void UART1_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 508 "./mcc_generated_files/uart1.h"
void UART1_SetErrorHandler(void (* interruptHandler)(void));
# 528 "./mcc_generated_files/uart1.h"
void (*UART1_RxInterruptHandler)(void);
# 546 "./mcc_generated_files/uart1.h"
void (*UART1_TxInterruptHandler)(void);
# 566 "./mcc_generated_files/uart1.h"
void UART1_SetRxInterruptHandler(void (* InterruptHandler)(void));
# 584 "./mcc_generated_files/uart1.h"
void UART1_SetTxInterruptHandler(void (* InterruptHandler)(void));
# 5 "funtions_frame.c" 2
...
int splitString(const char* str, char delimiter, char* tokens[]) {
    ...
    token = strtok(str, "#");
    while (token != ((void*)0) && tokenCount < 10) {
