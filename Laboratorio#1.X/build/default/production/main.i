...
unsigned int getdistancia(){
    ...
    while(PORTCbits.RC5==1){
        cont++;
        _delay((unsigned long)((58)*(64000000UL/4000000.0)));
    }
    return(cont);
...
void main(){
    ...
    while(1){
        ...
        _delay((unsigned long)((150)*(64000000UL/4000.0)));
    }
...
void MenuPrincipal(void){
    ...
    switch(opSel){
        ...
        case 2: lcd_char(2,7,' ');
                lcd_char(2,12,'<');
                break;
        case 3: while(opSel==3 && PORTBbits.RB4 == 1){
                lcd_char(2,7,' ');
                lcd_char(2,12,' ');
...
void MenuPrincipalCon(void){
    ...
    switch(opSel){
        case 1: while(opSel==1 && PORTBbits.RB4==1){
                lcd_char(2,1,'<');
                lcd_char(2,2,'-');
                _delay((unsigned long)((100)*(64000000UL/4000.0)));
                lcd_char(2,1,' ');
...
void MenuCalentador(void){
    ...
    if(PORTBbits.RB4 == 0){
        switch(opSel){
            case 1: PORTFbits.RF3 = 1;
                    estado=1;
                    break;
            case 2: PORTFbits.RF3 = 0;
                    estado=0;
                    break;
        }
    }
...
void MenuMotor(void){
    ...
    switch(opSel){
        ...
        case 3: lcd_char(2,16,'<');
                break;
        case 4: while(opSel==4 && PORTBbits.RB4==1){
    ...
    if(PORTBbits.RB4 == 0){
        switch(opSel){
            case 1: PORTEbits.RE0=1;
                    PORTCbits.RC1=0;
                    break;
            case 2: PORTEbits.RE0=0;
                    PORTCbits.RC1=1;
                    break;
            case 3: PORTEbits.RE0=0;
                    PORTCbits.RC1=0;
                    break;
        }
    }
